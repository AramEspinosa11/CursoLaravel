...
class BdController extends Controller
{
    ...
    {
        //firstorfail solo se utiliza cuando se obtiene un dato desde la url
    ...
    {
        // Si el registro no tiene ninguna foto asociada si se puede eliminar
    ...
    public function bd_productos_fotos_delete(Request $request, $producto_id, $foto_id)
    {
        ...
        unlink("C:/xampp/htdocs/Projects/Laravel/ejemplo1/public/uploads/productos/".$foto->nombre);
